<template>
  ...
  >
    ...
    <transition name="fade">
      <div
        v-if="!isOpen && !isLoading && showHint"
          ...
          <div
            ...
            :class="{
              ...
              'bg-gray-100 dark:bg-gray-700 ring-1 ring-gray-300 dark:ring-gray-600':
                highlightedIndex === index && modelValue !== option.value,
            }"
            :role="'option'"
            ...
            :ref="
              (el) => {
                if (el && highlightedIndex === index) highlightedElement = el
              }
            "
          >
            {{ option.label }}
