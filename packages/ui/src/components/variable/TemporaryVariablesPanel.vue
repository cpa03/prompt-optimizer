    ...
    <template #header-extra>
      <NSpace :size="8">
        <NButton
          ...
          :disabled="props.disabled || props.isGenerating || displayVariables.length === 0"
    ...
    <NSpace vertical :size="12">
      ...
      >
        <NTag
          ...
          "
          :style="{
            minWidth: UI_DIMENSIONS.TABLE_COL_WIDTH_NAME + 'px',
            maxWidth: '220px',
            flexShrink: 0,
          }"
        >
      ...
      <NSpace :size="8" justify="end">
        <!-- 添加变量按钮 -->
        <NButton size="small" :disabled="props.disabled" @click="showAddVariableDialog = true">
...
import { NCard, NSpace, NTag, NButton, NInput, NEmpty, NModal, NFormItem, NIcon } from 'naive-ui'
