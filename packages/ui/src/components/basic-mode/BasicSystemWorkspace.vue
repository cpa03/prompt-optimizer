<template>
  <div class="basic-system-workspace" data-testid="workspace" data-mode="basic-system">
    <div
      ref="splitRootRef"
...
const templateSelection = useWorkspaceTemplateSelection(services, session, 'optimize', 'iterate')
...
/* Note: .test-area-top, .test-area-label, .variant-deck, .split-divider, .variant-cell, 
