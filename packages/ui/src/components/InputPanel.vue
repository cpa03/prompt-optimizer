    ...
    <NFlex justify="space-between" align="center" :wrap="false">
      ...
      <NFlex align="center" :size="12">
        ...
        >
          ...
          {{
            extracting
              ? $t('evaluation.variableExtraction.extracting')
              : $t('evaluation.variableExtraction.extractButton')
          }}
        </NButton>
        <!-- 预览按钮 -->
        <NButton
...
import { NInput, NButton, NText, NSpace, NFlex, NGrid, NGridItem, NIcon, NPopover } from 'naive-ui'
