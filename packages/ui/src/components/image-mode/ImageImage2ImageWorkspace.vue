...
import { FILE_SIZE_LIMITS, COMPONENT_CONSTANTS, ANIMATION_CONSTANTS } from '../../config/constants'
...
// 图像生成相关
const { imageModels, generateImage2Image, validateImage2ImageRequest, loadImageModels } =
  useImageGeneration()
...
const handleSaveFavorite = (data: { content: string; originalContent?: string }) => {
  ...
  if (appHandleSaveFavorite) {
    ...
    console.warn('[ImageImage2ImageWorkspace] handleSaveFavorite not available from App.vue')
  }
}
