...
export const ANIMATION_CONSTANTS = {
  ...
  SCORE_CHANGE_DURATION_MS: 800,
  SCORE_INDICATOR_TIMEOUT_MS: 2000,

  // Animation durations (in seconds for CSS keyframes)
  ANIMATION_DURATION_FAST_S: '1s',
  ANIMATION_DURATION_NORMAL_S: '1.5s',
  ANIMATION_DURATION_SLOW_S: '2s',
  ANIMATION_DURATION_VERY_SLOW_S: '3s',

  // Animation delays (in seconds for CSS keyframes)
  ANIMATION_DELAY_NONE: '0s',
  ANIMATION_DELAY_FAST: '0.1s',
  ANIMATION_DELAY_NORMAL: '0.2s',
  ANIMATION_DELAY_SLOW: '0.3s',
  ANIMATION_DELAY_MEDIUM: '0.5s',
  ANIMATION_DELAY_LONG: '0.6s',
  ANIMATION_DELAY_VERY_LONG: '1s',
