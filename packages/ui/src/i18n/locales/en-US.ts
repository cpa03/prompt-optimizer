...
export default {
  ...
  modelManager: {
    ...
    modelKeyReserved:
      'Model key "{id}" conflicts with a built-in model. Please choose another key, or edit the built-in model configuration instead.',
  ...
  functionModel: {
    ...
    evaluationModelHint:
      'Used for intelligent evaluation and variable extraction, defaults to global optimization model',
  },
  templateManager: {
  ...
  test: {
    ...
    error: {
      ...
      forbiddenTemplateSyntax:
        'Unescaped Mustache syntax (e.g. triple braces or ampersand tags) is not supported. Please use normal variable placeholders.',
  ...
  prompt: {
    ...
    originalVersionTooltip:
      'Original input without optimization. Editing and saving will create a new version.',
  ...
  toast: {
    ...
    warning: {
      ...
      messageNotFoundInCurrentConversation:
        'Optimized message not found in current conversation, cannot restore',
      optimizeCompleteButHistoryFailed:
        'Optimization complete, but history save failed. Version management temporarily unavailable',
      iterateCompleteButHistoryFailed:
        'Iteration complete, but history save failed. Version management temporarily unavailable',
  ...
  contextEditor: {
    ...
    importPlaceholders: {
      ...
      smart:
        'Paste any supported JSON format (OpenAI, LangFuse, or conversation array). The editor will auto-detect the format.',
    },
  ...
  image: {
    ...
    params: {
      ...
      promptExtend: {
        ...
        description:
          'When enabled, the model will automatically expand and optimize the prompt for better results',
      },
      watermark: {
        label: 'Watermark',
  ...
  variableExtraction: {
    ...
    saveFailedWithUndo:
      'Failed to save variable {name}. Text has been replaced but variable was not saved. Press {undo} to undo',
  ...
  error: {
    ...
    image: {
      ...
      config_provider_mismatch:
        'Image config provider mismatch: config={configProviderId}, adapter={adapterProviderId}',
      connection_config_missing_field: 'Missing required connection field: {field}',
      connection_config_invalid_field_type:
        'Connection field {field} must be {expectedType}, got {actualType}',
      ...
      model_only_supports_image2image_need_input:
        'Model only supports image-to-image. Please provide an input image: {modelName}',
