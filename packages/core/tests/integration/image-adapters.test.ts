...
describe.skipIf(!RUN_REAL_API)('Image Adapters Real API Integration Tests', () => {
  ...
  const hasSeedreamKey = !!(
    process.env.VITE_SEEDREAM_API_KEY ||
  ...
  describe('Gemini 图像适配器测试', () => {
    ...
    it.runIf(runGeminiTests)(
      '应该能使用Gemini 2.5 Flash Image生成图像',
      async () => {
        // 添加Gemini图像模型
