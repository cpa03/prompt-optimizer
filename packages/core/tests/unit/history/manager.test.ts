...
describe('HistoryManager', () => {
  ...
  beforeEach(() => {
    ...
    historyManager = new HistoryManager(mockStorage, mockModelManager as any)
  ...
  describe('addRecord', () => {
    ...
    it('should throw RecordValidationError for an invalid record (e.g., missing originalPrompt)', async () => {
      ...
      await expect(historyManager.addRecord(invalidRecord)).rejects.toThrow(RecordValidationError)
    })
  })
