...
describe('ModelScopeImageAdapter', () => {
  ...
  describe('Image Generation', () => {
    test('should validate configuration before generating', async () => {
      ...
      await expect(adapter.generate(request, invalidConfig)).rejects.toMatchObject({
    ...
    test('should validate prompt is required', async () => {
      ...
      await expect(adapter.generate(invalidRequest, config)).rejects.toMatchObject({
  ...
  describe('Real API Tests', () => {
    ...
    test.skipIf(!hasApiKey)(
      'should successfully call ModelScope text-to-image API',
      async () => {
