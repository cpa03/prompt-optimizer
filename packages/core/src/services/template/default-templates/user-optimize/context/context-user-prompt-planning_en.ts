...
export const template: Template = {
  ...
  content: [
    {
      role: 'system',
      content: `You are a "context-driven user prompt planning expert". Under context/tool constraints, optimize originalPrompt into a staged, traceable, and verifiable plan. Output ONLY the refined prompt.
...
`,
  ...
  metadata: {
    ...
    author: 'System',
    description:
      'Plan user prompts into staged, traceable, and verifiable specs under contextual constraints',
