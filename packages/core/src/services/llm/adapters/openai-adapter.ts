...
const OPENAI_STATIC_MODELS: ModelOverride[] = [
  {
    ...
    capabilities: {
      ...
      maxContextLength: MODEL_MAX_CONTEXT.GPT_LATEST,
    },
  },
  {
  ...
  protected getParameterDefinitions(_modelId: string): readonly ParameterDefinition[] {
    return [
      ...
      },
      {
        ...
        type: 'number',
        defaultValue: MODEL_SAMPLING_LIMITS.TOP_P.DEFAULT,
        default: MODEL_SAMPLING_LIMITS.TOP_P.DEFAULT,
      ...
      },
      {
        ...
        type: 'integer',
        minValue: 1,
        maxValue: MODEL_TOKEN_LIMITS.OPENAI_MAX,
        min: 1,
        max: MODEL_TOKEN_LIMITS.OPENAI_MAX,
        step: 1,
      ...
      },
      {
        ...
        type: 'integer',
        minValue: 0,
        maxValue: MODEL_LOGPROBS_LIMITS.TOP_LOGPROBS_MAX,
        min: 0,
        max: MODEL_LOGPROBS_LIMITS.TOP_LOGPROBS_MAX,
        step: 1,
      },
      {
        name: 'seed',
      ...
      },
      {
        ...
        type: 'integer',
        defaultValue: MODEL_COMPLETION_LIMITS.N_MIN,
        default: MODEL_COMPLETION_LIMITS.N_MIN,
        minValue: MODEL_COMPLETION_LIMITS.N_MIN,
        maxValue: MODEL_COMPLETION_LIMITS.N_MAX,
        min: MODEL_COMPLETION_LIMITS.N_MIN,
        max: MODEL_COMPLETION_LIMITS.N_MAX,
        step: 1,
      },
      {
        name: 'timeout',
        ...
        type: 'integer',
        defaultValue: MODEL_TIMEOUT_LIMITS.DEFAULT_MS,
        default: MODEL_TIMEOUT_LIMITS.DEFAULT_MS,
        minValue: MODEL_TIMEOUT_LIMITS.MIN_MS,
        maxValue: MODEL_TIMEOUT_LIMITS.MAX_MS,
        min: MODEL_TIMEOUT_LIMITS.MIN_MS,
        max: MODEL_TIMEOUT_LIMITS.MAX_MS,
        step: 1000,
        unit: 'ms',
      },
    ]
